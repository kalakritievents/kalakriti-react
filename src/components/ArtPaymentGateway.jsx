...
const ArtPaymentGateway = () => {
    ...
    const [paymentLink, setPaymentLink] = useState('https://rzp.io/l/EYLwSZg9j'); // Default payment link
    ...
    const handleArtworkCountChange = (event) => {
        ...
        switch (count) {
            case 1:
                setAmount(150);
                setPaymentLink('https://rzp.io/l/EYLwSZg9j');
                break;
            case 2:
                setAmount(220);
                setPaymentLink('https://rzp.io/l/OOHvoq7tV');
                break;
            case 3:
                setAmount(320);
                setPaymentLink('https://rzp.io/l/6WIhjPTKm');
                break;
            case 4:
                setAmount(420);
                setPaymentLink('https://rzp.io/l/GruzX6esV6');
                break;
            case 5:
                setAmount(520);
                setPaymentLink('https://rzp.io/l/ZVomCJPHv');
                break;
            case 6:
                setAmount(620);
                setPaymentLink('https://rzp.io/l/7N4RcpdB');
                break;
            case 7:
                setAmount(720);
                setPaymentLink('https://rzp.io/l/8pkS0kR63');
                break;
            case 8:
                setAmount(820);
                setPaymentLink('https://rzp.io/l/ontLARn');
                break;
            case 9:
                setAmount(920);
                setPaymentLink('https://rzp.io/l/zblwcoyOS');
                break;
            case 10:
                setAmount(999);
                setPaymentLink('https://rzp.io/l/dl6JZITr');
                break;
            default:
                setAmount(150);
                setPaymentLink('https://rzp.io/l/EYLwSZg9j');
