...
const artworkImports = [
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay1.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay2.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay3.jpeg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay4.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay5.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay6.jpeg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay7.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay8.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay9.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay10.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay11.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay12.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay13.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay14.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay15.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay16.jpg'),
    require('../assets/events/ArtEvent/ArtWorks/ArtworkDay17.jpg'),
    ...
    return (
        <div>
            ...
            <div className={styles.artEventPage}>
                <h1 className={styles.titleArtworks}>Artworks Of The Day</h1>
