...
const ArtPaymentGateway = () => {
    ...
    const [paymentLink, setPaymentLink] = useState('https://rzp.io/l/lhmGPXGzPx'); // Default payment link
    ...
    const handleArtworkCountChange = (event) => {
        ...
        switch (count) {
            case 1:
                setAmount(150);
                setPaymentLink('https://rzp.io/l/lhmGPXGzPx');
                break;
            case 2:
                setAmount(220);
                setPaymentLink('https://rzp.io/l/tqoM96M3tI');
                break;
            case 3:
                setAmount(320);
                setPaymentLink('https://rzp.io/l/NsJUX1n0N');
                break;
            case 4:
                setAmount(420);
                setPaymentLink('https://rzp.io/l/HCsCwNPkL');
                break;
            case 5:
                setAmount(520);
                setPaymentLink('https://rzp.io/l/4ZMXxuzfh');
                break;
            case 6:
                setAmount(620);
                setPaymentLink('https://rzp.io/l/zQWIzORv');
                break;
            case 7:
                setAmount(720);
                setPaymentLink('https://rzp.io/l/UqgZtt0');
                break;
            case 8:
                setAmount(820);
                setPaymentLink('https://rzp.io/l/BtdKNK3H9e');
                break;
            case 9:
                setAmount(920);
                setPaymentLink('https://rzp.io/l/sBMnzLH5');
                break;
            case 10:
                setAmount(999);
                setPaymentLink('https://rzp.io/l/hKLD0g1cY');
                break;
            default:
                setAmount(150);
                setPaymentLink('https://rzp.io/l/lhmGPXGzPx');
