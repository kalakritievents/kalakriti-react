...
const ArtPaymentGateway = () => {
    ...
    const [paymentLink, setPaymentLink] = useState('https://rzp.io/l/aWAn12K'); // Default payment link
    ...
    const handleArtworkCountChange = (event) => {
        ...
        switch (count) {
            case 1:
                setAmount(150);
                setPaymentLink('https://rzp.io/l/aWAn12K');
                break;
            case 2:
                setAmount(220);
                setPaymentLink('https://rzp.io/l/ocFNf0VEo');
                break;
            case 3:
                setAmount(320);
                setPaymentLink('https://rzp.io/l/5miuPmDj3x');
                break;
            case 4:
                setAmount(420);
                setPaymentLink('https://rzp.io/l/4Tn687VBZ');
                break;
            case 5:
                setAmount(520);
                setPaymentLink('https://rzp.io/l/De1Xzha');
                break;
            case 6:
                setAmount(620);
                setPaymentLink('https://rzp.io/l/IlQSB0C');
                break;
            case 7:
                setAmount(720);
                setPaymentLink('https://rzp.io/l/wJEyGQK4');
                break;
            case 8:
                setAmount(820);
                setPaymentLink('https://rzp.io/l/vXWDWBT');
                break;
            case 9:
                setAmount(920);
                setPaymentLink('https://rzp.io/l/Br6K7KM');
                break;
            case 10:
                setAmount(999);
                setPaymentLink('https://rzp.io/l/cIET4nI');
                break;
            default:
                setAmount(150);
                setPaymentLink('https://rzp.io/l/aWAn12K');
