...
{/*         <span className={styles.updated}>(Updated)</span> */}
      ...
      <div className={styles.datesContainer}>
        <div className={styles.dateBox}>
          ...
          <p className={styles.date}>15th January 2025</p>
        </div>
        <div className={styles.dateBox}>
          <p className={styles.dateTitle}>Registration Start Date</p>
          <p className={styles.date}>01st January 2025</p>
        </div>
        <div className={styles.dateBox}>
          <p className={styles.dateTitle}>Result Date</p>
          <p className={styles.date}>16th January 2025</p>
        </div>
        <div className={styles.dateBox}>
          <p className={styles.dateTitle}>Prize Distribution</p>
          <p className={styles.date}>19th January 2025</p>
        </div>
      </div>
    </div>
  );
